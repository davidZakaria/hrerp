...
// Get employee summary for admin dashboard overview (live pay-period data)
router.get('/employee-summary', auth, async (req, res) => {
  try {
    ...
    const { rangeStart, rangeEnd, periodLabel, closingMonthKey } = parsePeriodQuery(req.query);
