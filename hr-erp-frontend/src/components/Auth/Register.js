...
const Register = ({ onBack, onRegisterSuccess }) => {
  ...
  const departments = ['Human Resources', 'Finance', 'Marketing', 'Sales', 'Information Technology', 'Operations', 'Engineer', 'Customer Service', 'Legal', 'Community', 'Reception', 'Jamila Engineer', 'Jura Engineer', 'Green Icon Engineer', 'Green Avenue Engineer', 'Architectural Engineer', 'Technical Office Engineer', 'Personal Assistant', 'Administration', 'Supply Chain Department', 'Site Service', 'Driver', 'Other'];
